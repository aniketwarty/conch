...
import { Question, TrueFalseQuestion } from "../../lib/classes/question";
...
export const QuizGenerator = ({studySetString, options}: QuizGeneratorProps) => {
    ...
    useEffect(() => {
        //logic to use options and studySet to generate a list of Questions
            ...
            for (const questionType of enabledQuestionTypes) {
                if (questionType === "True/False Questions") {
                    for (let i = 0; i < options["Number of Questions"]/enabledQuestionTypes.length + options["Number of Questions"]%enabledQuestionTypes.length; i++) {
                        questionList.push(Question.createTrueFalse(studySet, setIndex, true));
    ...
    //function to generate html based on the Question
            ...
            return(
                <div className="flex flex-row mt-2">
                    ...
                    <div className="flex flex-col w-full mx-5 mb-10">
                        <div key={index} className="flex flex-row w-full p-2 items-center shadow-2xl rounded-lg">
    ...
    return (
        <div className="flex flex-col h-5/6 w-2/3 shadow-2xl m-auto p-5 items-center overflow-auto">
